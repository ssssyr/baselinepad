META_CONFIG = {
    'ckpt_path': "/mnt/sda/syr/checkpoint/checkpoint1223/best_action_loss.pt", # 使用你的模型
    ...
    'max_steps': 25, # max planning steps for each rollout
    'video_dir': "output",
    'visualize_prediction': True,
    'denoise_steps': 50, # joint denoise step
    'task_list': ['drawer-close-v2'], # 只测试button-press-v2任务
    'gpu_id': 1
}
