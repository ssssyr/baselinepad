...
def save_config(config: argparse.Namespace, save_path: str):
    ...
    section_mapping = {
        ...
        'moe': ['use_moe', 'num_experts', 'moe_top_k', 'aux_loss_weight', 'router_z_loss_weight', 'moe_start_layer', 'moe_shared_experts', 'use_modality_bias', 'modality_bias_strength_action', 'modality_bias_strength_depth'],
